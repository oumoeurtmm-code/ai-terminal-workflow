...
- [x] Build concrete n8n JSON export for new-hire provisioning flow
- [x] Build concrete n8n JSON export for access request flow
- [x] Add Python demo scripts (standalone, no n8n required) — scripts/ directory
- [x] Add Docker Compose quickstart — docker-compose.yml + setup.md
...
- [ ] Upgrade workflow JSONs to use webhook triggers (currently manual trigger only)
